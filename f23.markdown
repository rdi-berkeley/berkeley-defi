...
<iframe id="syllabus" src="./f23_syllabus" width="100%" height="100" frameborder=0> </iframe>
...
Students enrolled in 1 unit are expected to submit a 500-word summary article of one of the lectures. Alternatively, students that attend The [Future of Decentralization, AI, and Computing Summit](https://rdi.berkeley.edu/events/sbcberkeley) in-person may write an article summarizing a topic learned at the summit -- bonus points will be awarded for this option if the article is publicly accessible.
...
Students who wish to choose the summit option may fill out this [submission form](https://forms.gle/qH5grBy39f8TE2zAA) before Sep 8.
